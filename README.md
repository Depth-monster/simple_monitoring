...
Проблема не в том, что кто-то "украдёт" лог, а в том, что информация из него может быть использована для атак или диагностики — например, злоумышленник поймёт, как часто падает твой процесс, и подберёт момент.
